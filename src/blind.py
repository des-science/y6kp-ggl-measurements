...
def blind_measurements(name):
        ...
        os.system('python pipeline/blind_2pt_usingcosmosis.py -s I_desperately_need_coffee -i pipeline/blinding_params_template_%s.ini -b add -u %s'%(config['lens_v'], filename_absolute_path))
        os.chdir(owd)
