...
class GGL(object):
    ...
    def setup_run(self, path=None, lens_file=None, source_file=None, randoms_file=None, 
        ...
        self.ra_l, self.dec_l, self.weight_lens = self.ggl_setup.load_lens_Y6_maglim(path, zl_bin=lens_bin)
        ...
        (self.ra_s, self.dec_s, 
         ...
         self.R_g, self.w_g) = self.ggl_setup.load_source_metadetect(path, zs_bin=source_bin)
