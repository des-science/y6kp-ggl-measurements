...
filename = '../lens_cats/redmagic/highdens_original/y3_gold_2.0_wide_sofcol_run_redmapper_v6.4.21_redmagic_highdens_0.5-10.fit'
rm = pf.getdata(filename)
zbins = zbins['lims']
z_l = rm['zredmagic']
...
ra_l = rm['ra'][maskzl]
dec_l = rm['dec'][maskzl] 
zerr_l = rm['zredmagic_e'][maskzl] 
ids = rm['coadd_objects_id'][maskzl]
...
path = '../lens_cats/redmagic/%s_original'%params_rm['table'][0]
